...
public class JNICLoader {
    ...
    public static void load(String libName, Class<?> clazz) {
        if (!loaded) {
            try {
                // Check if already loaded by System.loadLibrary (e.g. in dev environment)
                ...
                InputStream is = JNICLoader.class.getResourceAsStream("/cn/sky/jnic/000000000000000000000000000000000000.dat");
                if (is == null) {
